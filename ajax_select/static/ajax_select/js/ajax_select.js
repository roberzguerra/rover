    ...
    return this.each(function() {
      ...
      function addKiller(repr, pk) {
        var killId = 'kill_' + pk + id,
            ...
            btnChange = '';
        if (options.url_edit) {
          btnChange = '<a href="'+ options.url_edit + pk + '" class="ui-icon ui-icon-pencil" onclick="return showAddAnotherPopup(this);">Editar</a> ';
        }

        if (repr) {
          $deck.empty();
          $deck.append('<div>' + killButton + repr + btnChange + '</div>');
        } else {
    ...
    return this.each(function() {
      ...
      function addKiller(repr, pk) {
        var killId = 'kill_' + pk + id,
            ...
            btnChange = '';
        if (true) {
          btnChange = '<a href="/admin/events/block/' + pk + '/" class="ui-icon ui-icon-pencil" onclick="return showAddAnotherPopup(this);">Editar</a> ';
        }

        $deck.append('<div id="' + id + '_on_deck_' + pk + '">' + killButton + '<span class="ajax_select_item">' +  repr + '</span>' + btnChange + ' </div>');
